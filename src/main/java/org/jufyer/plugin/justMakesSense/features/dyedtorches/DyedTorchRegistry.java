...
public class DyedTorchRegistry {

  private static final Map<DyedTorchVariant, ItemStack> TORCH_ITEMS = new HashMap<>();
  ...
  public static ItemStack getTorchItem(DyedTorchVariant variant) {
    ItemStack item = TORCH_ITEMS.get(variant);
    return (item != null) ? item.clone() : null;
  }

  public static ItemStack DyedTorchItem1to1(DyedTorchVariant variant) {
    return TORCH_ITEMS.get(variant);
  }

  public static ItemDisplay spawnDyedTorchDisplay(DyedTorchVariant variant, Location location, BlockFace blockFace) {
...
//    particleBuilder.spawn();
  ...
  private static void updateDisplayVisuals(ItemDisplay display, DyedTorchVariant variant, BlockFace facing) {
